---
title: Ledger state and transaction simulation in Tican-core
---

Minimum supported ledger version: 12

Tican-core has built-in functionality to scale any existing ledger state by a specific multiplier,
...
`Tican-core simulate-bucketlist <L> --multiplier <MULTIPLIER>`
...
`Tican-core generate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L> --multiplier <MULTIPLIER>`
...
`Tican-core simulate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L>`
